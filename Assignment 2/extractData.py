...
from buildClassifier import build_classifier
from testClassifier import test_classifier
...
if __name__ == "__main__":
    ...
    print("Making training and testing files")
    trainingData = makeTrainingSet(data)
    testData = makeTestSet(data)
    print("Building classifier")
    greaterlist, lesslist = build_classifier(trainingData)
    print("Classifying test data")
    test_classifier(testData, greaterlist, lesslist)
